...
public class CONSULTAS_ADMINISTRATIVAS extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnDoctores.setBackground(new java.awt.Color(0, 153, 153));
        btnDoctores.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        ...
        btnGuiaTelefonica.setBackground(new java.awt.Color(0, 153, 153));
        btnGuiaTelefonica.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        ...
        btnDISPOCAMAS.setBackground(new java.awt.Color(0, 153, 153));
        btnDISPOCAMAS.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        ...
        btnDISPOCAMAS1.setBackground(new java.awt.Color(0, 153, 153));
        btnDISPOCAMAS1.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        ...
        titulo.setText("CONSULTAS ADMINISTRATIVAS");
        ...
        btnConsultasGenerales.setBackground(new java.awt.Color(0, 153, 153));
        btnConsultasGenerales.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        ...
        btnHistorial.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        ...
        btnCitas.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
    ...
    private void btnHistorialActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHistorialActionPerformed
        ...
        PANEL_INTRO.removeAll();
        PANEL_INTRO.add(hm, BorderLayout.CENTER);
        PANEL_INTRO.revalidate();
        PANEL_INTRO.repaint();

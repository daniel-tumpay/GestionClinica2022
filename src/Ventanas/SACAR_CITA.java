...
public class SACAR_CITA extends javax.swing.JPanel {
    ...
    private void btRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btRegistrarActionPerformed
        ...
        String  dni, especialidad, turno, doc;
        ...
        if(ValidarForm()){
            //AGREGANDO SERVICIO AL HISTORIAL
            dni =this.txtpaciente.getText();
            ...
            //AGREGANDO A LA LISTA DE LISTAS
            datos_paciente = Sistema.planilla.CopiarDatosPaciente(dni);

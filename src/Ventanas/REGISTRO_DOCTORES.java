...
public class REGISTRO_DOCTORES extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        comboArea.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Sin Seleccionar", "Consulta", "Hospitalizacion" }));
    ...
    private void btRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btRegistrarActionPerformed
        ...
        if(ValidarForm()){
            ...
            if(ConexionCorrecta()){
                if(Sistema.planilla.getDoctores().HayCupo(especialidad, area)){                
                    if (Sistema.planilla.ingresarDoctor(doct)) {
                        Sistema.planilla.getDoctores().DisminuirVacantes(especialidad, area);
                        if(doct.getArea().equals("Consulta")){
                            if (Sistema.planilla.ingresarDoctorCitas(doct)) {
                                JOptionPane.showMessageDialog(this, "Se guardó también en el registro de doctores para consultas");
                            }
                        }                
                        JOptionPane.showMessageDialog(this, "Registro concluido exitosamente.");
                    }else{
                        JOptionPane.showMessageDialog(this, "Ya existe un doctor en el sistema con ese código");
                    }
                }else{
                    JOptionPane.showMessageDialog(this, "Ya no hay cupos en el area de " + area + " para la especialidad de " + especialidad);
                }
            }
        }else{
    ...
    public boolean ConexionCorrecta() { //Entre area y especialidad
        boolean result=true;
        String especialidad =this.comboEspecialidad.getSelectedItem().toString();
        String area = this.comboArea.getSelectedItem().toString();
        if(area == "Hospitalizacion"){
            if(especialidad == "Odontología" || especialidad == "Nutrición" || especialidad == "Psicología"){
                result = false; 
                JOptionPane.showMessageDialog(this, "No existe hospitalización de " + especialidad);
            }
        }
        return result;
    }
